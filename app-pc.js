...
function showFallback(e){document.getElementById('map').innerHTML='<div class="fallback-map"><div><b>地図を読み込めませんでした</b><br>左側リストのGoogle Mapsボタンで確認してください。</div></div>'; console.error(e)}
